...
import { ArrowRight, BarChart3, Brain, Code, Database, Globe, Layers, MessageSquare } from "lucide-react"
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Our solutions are designed to deliver measurable results and ROI for your business.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
                ...
                <p className="text-center text-gray-500">
                  With experience across industries and regions, we bring global expertise to local challenges.
                </p>
              </div>
            </div>
          </div>
