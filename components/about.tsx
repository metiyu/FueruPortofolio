...
import { PRIMARY_LIGHT } from "./lib/color";
...
export default function AboutSection() {
    ...
    return (
        ...
        // >
            <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-background-light relative">
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center justify-center space-y-4 text-center">
                        <div className="space-y-2">
                            <AnimationOnScroll
                                ...
                                delay={200}
                            >
                                <div className="inline-block rounded-lg px-3 text-sm text-secondary-light md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">About Us</div>
                            </AnimationOnScroll>
                            ...
                            <AnimationOnScroll
                                ...
                                delay={300}
                            >
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-primary-light pb-1">
                    ...
                    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-4 md:grid-cols-2 lg:grid-cols-3">
                        <AnimationOnScroll
                            ...
                            delay={600}
                        >
                            <div className="m-7 group relative overflow-hidden rounded-lg shadow-sm transition-all duration-1000 hover:shadow-shown hover:scale-[1.02] hover:-translate-y-1" onMouseEnter={() => boltRef.current?.playFromBeginning()}>
                                <div className="p-6 items-center flex flex-col">
                                    <div className="rounded-full mb-4 p-3 transition-transform duration-1000 group-hover:scale-110">
                                        <BoltIcon ref={boltRef} color={`primary:${PRIMARY_LIGHT}`} />
                                    </div>
                                    <h3 className="text-xl font-bold mb-2 text-primary-light">Pioneering Excellence</h3>
                                    <p className="text-secondary-light mb-4 text-center">
                        ...
                        <AnimationOnScroll
                            ...
                            delay={600}
                        >
                            <div className="m-7 group relative overflow-hidden rounded-lg shadow-sm transition-all duration-1000 hover:shadow-shown hover:scale-[1.02] hover:-translate-y-1" onMouseEnter={() => heartRef.current?.playFromBeginning()}>
                                <div className="p-6 items-center flex flex-col">
                                    <div className="rounded-full mb-4 p-3 transition-transform duration-1000 group-hover:scale-110">
                                        <HeartIcon ref={heartRef} color={`primary:${PRIMARY_LIGHT}`} />
                                    </div>
                                    <h3 className="text-xl font-bold mb-2 text-primary-light">Pioneering Excellence</h3>
                                    <p className="text-secondary-light mb-4 text-center">
                        ...
                        <AnimationOnScroll
                            ...
                            delay={600}
                        >
                            <div className="m-7 group relative overflow-hidden rounded-lg shadow-sm transition-all duration-1000 hover:shadow-shown hover:scale-[1.02] hover:-translate-y-1" onMouseEnter={() => increaseRef.current?.playFromBeginning()}>
                                <div className="p-6 items-center flex flex-col">
                                    <div className="rounded-full mb-4 p-3 transition-transform duration-1000 group-hover:scale-110">
                                        <IncreaseIcon ref={increaseRef} color={`primary:${PRIMARY_LIGHT}`} />
                                    </div>
                                    <h3 className="text-xl font-bold mb-2 text-primary-light">Pioneering Excellence</h3>
                                    <p className="text-secondary-light mb-4 text-center">
